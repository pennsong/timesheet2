...
public class 简单成功 extends TimesheetApplicationTests {
    ...
    private static String dumpFileName = "user.generateOwnYongHuBaoGao.JianDanChengGong";
    ...
    // 正式测试案例开始
    @Test
    public void 生成本人用户报告() throws JSONException {
...
//        Assert.assertEquals(2, xmhz.getJSONObject(1).getInt("耗时"));
    ...
    @Test
    public void 生成本人用户报告_开始时间等于结束时间() throws JSONException {
    		YongHu yongHu = yongHuRepository.findOneByYongHuMing("y1");
