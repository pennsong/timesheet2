package com.example.timesheet.admin.queryGongZuoJiLu;
...
public class 简单成功 extends TimesheetApplicationTests {
    ...
    private static String dumpFileName = "admin.queryGongZuoJiLu.JianDanChengGong";
    ...
    // 正式测试案例开始
    @Test
    public void 查询工作记录_无任何参数限制() throws JSONException {
        ResponseEntity<String> response = request(
                "/admin/queryGongZuoJiLu" ,
                HttpMethod.POST,
                "Admin"
        );
    ...
    @Test
    public void 查询工作记录_有页码_有时间范围_有公司限制_有用户限制() throws JSONException {
    	    // 页码
    		ResponseEntity<String> response = request(
                "/admin/queryGongZuoJiLu" ,
                HttpMethod.POST,
    ...
    @Test
    public void 查询工作记录_开始日期等于结束日期() throws JSONException{
    		ResponseEntity<String> response = request(
                "/admin/queryGongZuoJiLu" ,
                HttpMethod.POST,
                "Admin",
