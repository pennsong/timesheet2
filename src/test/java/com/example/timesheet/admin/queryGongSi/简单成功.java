package com.example.timesheet.admin.queryGongSi;
...
public class 简单成功 extends TimesheetApplicationTests {
    ...
    private static String dumpFileName = "admin.queryGongSi.JianDanChengGong";
    ...
    // 正式测试案例开始
    @Test
    public void 查询公司_有页码() throws JSONException {
        ...
        Assert.assertEquals("g1", jsonObject.getJSONArray("data").getJSONObject(0).get("mingCheng"));
        Assert.assertEquals(3, jsonObject.getJSONObject("ppPageInfo").getLong("totalElements"));
        Assert.assertEquals(3, jsonObject.getJSONObject("ppPageInfo").getInt("totalPages"));
    }
    
    @Test
    public void 查询公司_无页码() throws JSONException {
    		ResponseEntity<String> response = request(
                "/admin/queryGongSi",
                HttpMethod.POST,
                "Admin"
