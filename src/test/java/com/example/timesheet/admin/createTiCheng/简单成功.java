...
public class 简单成功 extends TimesheetApplicationTests {
    ...
    private static String dumpFileName = "admin.createTiCheng.JianDanChengGong";
    ...
    public void 新建提成() {
        ...
        Boolean result = StreamSupport.stream(tiChengRepository.findAll().spliterator(), false)
                .anyMatch(item -> item.getYongHu().getYongHuMing().equals("y1")
