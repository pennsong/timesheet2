...
public class 失败 extends TimesheetApplicationTests {
    ...
    private static String dumpFileName = "admin.setYongHuJieSuanRi.ShiBai";
    ...
    public void 设置个人结算日_结算日小于最小日期() {
        ...
        Assert.assertEquals(true, yongHu.getJieSuanRi().isEqual(LocalDate.of(1900, 1, 1)));
    }
}
