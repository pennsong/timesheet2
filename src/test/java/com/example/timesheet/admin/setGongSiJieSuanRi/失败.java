package com.example.timesheet.admin.setGongSiJieSuanRi;
...
public class 失败 extends TimesheetApplicationTests {
    ...
    private static String dumpFileName = "admin.setGongSiJieSuanRi.ShiBai";
    ...
    public void 设置公司结算日_结算日小于最小日期() {
        ...
        ResponseEntity<String> response = request(
                ...
                "Admin",
                "id, " + gongSi.getId(),
                "jieSuanRi, " + PPUtil.MIN_DATE.minusDays(1)
        );
        ...
        Assert.assertEquals(true, gongSi.getJieSuanRi().isEqual(LocalDate.of(1900, 1, 1)));
    }
}
